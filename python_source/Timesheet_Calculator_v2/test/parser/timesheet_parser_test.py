...
class TimesheetParserTest(unittest.TestCase):
    def test_parse_001(self):
        ...
        self.assertEqual(ts_list[0].tasks[0].get_date(), datetime.datetime.strptime("06/06/2021", "%d/%m/%Y").date())
        self.assertEqual(ts_list[0].tasks[0].get_time_in(), datetime.datetime.strptime("09:00 AM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_time_out(), datetime.datetime.strptime("06:00 PM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_task_name(), "task1")
        self.assertEqual(ts_list[0].tasks[0].get_project_name(), "project1")
    ...
    def test_parse_002(self):
        ...
        self.assertEqual(ts_list[0].tasks[0].get_date(), datetime.datetime.strptime("09/06/2021", "%d/%m/%Y").date())
        self.assertEqual(ts_list[0].tasks[0].get_time_in(), datetime.datetime.strptime("09:00 AM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_time_out(), datetime.datetime.strptime("06:00 PM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_task_name(), "task1")
        self.assertEqual(ts_list[0].tasks[0].get_project_name(), "project1")
    ...
    def test_parse_003(self):
        ...
        self.assertEqual(ts_list[0].tasks[0].get_date(), datetime.date(year=2021, month=6, day=6))
        self.assertEqual(ts_list[0].tasks[0].get_time_in(), datetime.datetime.strptime("09:00 AM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_time_out(), datetime.datetime.strptime("06:00 PM", "%I:%M %p").time())
        self.assertEqual(ts_list[0].tasks[0].get_task_name(), "task2")
        self.assertEqual(ts_list[0].tasks[0].get_project_name(), "project2")
        # remove testdata in input folder
        os.remove(dest)
        # remove result files in output folder